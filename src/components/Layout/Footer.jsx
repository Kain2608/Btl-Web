          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-3">
                <a href="https://www.facebook.com/caulongvnbadminton/" className="w-8 h-8 rounded-full border border-gray-400 flex items-center justify-center hover:border-[#ea5c0b] hover:text-[#ea5c0b] transition-colors">
                ...
                <a href="https://www.youtube.com/channel/UCrXy3yI0blu7JC5O84_eggg" className="w-8 h-8 rounded-full border border-gray-400 flex items-center justify-center hover:border-[#ea5c0b] hover:text-[#ea5c0b] transition-colors">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
